<script lang="ts">
    ...
    const tips: [string, ...[string, string][]][] = [
        [
            'Welcome to <strong>Graph Visualizer!!</strong><br>Graph Visualizer allows you to generate graphs and visualise some common graph-based algorithms.',
        ...
        [
            'To create your own graph, you can use the toolbar in the bottom right. Here, you can choose from several modes which allow you to create/delete nodes and edges.',
